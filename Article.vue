<template>
  <div>
    ...
    <div
      ...
      :class="{ 'kb-no-copy': isCustomerPortal }"
      @contextmenu="isCustomerPortal ? $event.preventDefault() : null"
      @keydown="isCustomerPortal ? preventCopy($event) : null"
    >
